...
Este archivo resume los valores de control exportados desde el dataset limpio y constituye la referencia principal para verificar el comportamiento del dashboard v0.9.
...
Esta validación documenta la correspondencia entre el dashboard y el resumen de control disponible en el repositorio. No sustituye la revisión visual final del archivo PBIX en Power BI Desktop, pero sí aporta una base académica verificable para justificar la consistencia del modelo.
