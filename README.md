...
Proyecto final para la asignatura **Proyecto: Análisis de Datos** del **Grado en Ingeniería de Organización Industrial**. El repositorio documenta y organiza el desarrollo de un dashboard ejecutivo en **Microsoft Power BI** que analiza el desempeño comercial de una empresa omnicanal durante el ejercicio 2025.

El proyecto aborda un escenario de análisis de datos aplicado a una empresa omnicanal especializada en **Tecnología** y **Estilo de Vida**, con actividad en **España, México, Argentina, Chile y Colombia**.

El problema de negocio planteado consiste en ayudar al comité directivo a determinar si el crecimiento de 2025 ha sido **equilibrado, eficiente y sostenible**, identificando diferencias por país, canal, categoría y evaluando satisfacción del cliente y eficiencia logística.

- **Herramienta principal:** Power BI
- **Lenguaje de soporte:** Python
- **Estado:** Dashboard final
...
Este repositorio corresponde al proyecto final de la asignatura **Proyecto: Análisis de Datos** del **Grado en Ingeniería de Organización Industrial**, desarrollado por **Marc Cubero Cantavella** como entrega académica formal. Su finalidad es demostrar competencias en análisis de datos, modelado semántico, visualización ejecutiva y documentación técnica.

La documentación del repositorio está organizada para respaldar una evaluación universitaria completa: memoria, metodología, diccionario de datos, prompts utilizados, checklist de entrega, guion de defensa, criterios de validación y trazabilidad de requisitos.

## Contexto empresarial

**NovaMarket Retail** es una empresa ficticia omnicanal especializada en productos de **Tecnología** y **Estilo de Vida**. El caso reproduce una operación comercial con presencia en cinco mercados principales:
...
La compañía comercializa sus productos a través de **tres canales de venta** y el análisis se centra en el ejercicio completo de **2025**, con una perspectiva de seguimiento ejecutivo del desempeño global.

## Problema de negocio

El comité directivo de NovaMarket Retail necesita determinar si el crecimiento observado en 2025 ha sido **equilibrado, eficiente y sostenible**. No basta con conocer el volumen de ingresos: también es preciso evaluar si dicho crecimiento se distribuye equitativamente entre mercados, canales y categorías, y si se sostiene con niveles adecuados de satisfacción del cliente y eficiencia logística.
...
El proyecto utiliza un dataset en formato **CSV** con registros transaccionales del año 2025. El conjunto de datos original se conserva en [`data/raw/`](data/raw/) y la versión limpia para análisis en [`data/processed/`](data/processed/).
...
**Estado del archivo PBIX:** el dashboard final está disponible en [`powerbi/NovaMarket_Retail_Dashboard.pbix`](powerbi/NovaMarket_Retail_Dashboard.pbix).
...
El dashboard final está disponible en [`powerbi/NovaMarket_Retail_Dashboard.pbix`](powerbi/NovaMarket_Retail_Dashboard.pbix).

## Medidas DAX

Las medidas oficiales del modelo se documentan en [`powerbi/dax/medidas_dax.md`](powerbi/dax/medidas_dax.md). Este archivo centraliza la definición de KPIs y facilita la trazabilidad entre el dashboard ejecutivo y el modelo de datos.
...
- Dashboard PBIX final disponible en [`powerbi/NovaMarket_Retail_Dashboard.pbix`](powerbi/NovaMarket_Retail_Dashboard.pbix).
...
**Marc Cubero Cantavella** ha creado una **landing page pública** como material complementario de comunicación para presentar visualmente el proyecto:

**Enlace:** [https://novamarket-retail.vercel.app/](https://novamarket-retail.vercel.app/)

La landing page ofrece una introducción accesible al caso empresarial, el problema de negocio y los principales resultados del análisis. Es un recurso de apoyo y **no sustituye** al dashboard Power BI oficial.

Fue creada con el apoyo de **GitHub Copilot** y revisada por **Marc Cubero Cantavella** antes de su publicación. La documentación completa sobre la landing page se encuentra en [`docs/landing_page.md`](docs/landing_page.md).
...
El proyecto ha utilizado herramientas de **IA generativa y asistencia tipo Copilot** como apoyo en tareas de **generación**, **validación**, **documentación** y **planificación**, siempre bajo supervisión académica y en cumplimiento de la política de uso responsable de la institución.

La trazabilidad de este apoyo se documenta en [`docs/prompts_utilizados.md`](docs/prompts_utilizados.md), donde se recoge el alcance del uso de IA, sus límites y los criterios de verificación aplicados.

## Nota de uso académico

Este repositorio tiene fines **exclusivamente académicos** y **no comerciales**. Su contenido se presenta como parte de una entrega universitaria y no debe interpretarse como un producto empresarial real.
