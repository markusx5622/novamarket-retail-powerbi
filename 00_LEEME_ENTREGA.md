...
- **Estado del dashboard:** versión `v0.9` disponible para revisión del profesor.
- **Archivo principal Power BI:** [`powerbi/NovaMarket_Retail_Dashboard_v0.9_revision_profesor.pbix`](powerbi/NovaMarket_Retail_Dashboard_v0.9_revision_profesor.pbix)
...
|---|---|
| Dashboard Power BI | [`powerbi/NovaMarket_Retail_Dashboard_v0.9_revision_profesor.pbix`](powerbi/NovaMarket_Retail_Dashboard_v0.9_revision_profesor.pbix) |
...
- Archivo: [`powerbi/NovaMarket_Retail_Dashboard_v0.9_revision_profesor.pbix`](powerbi/NovaMarket_Retail_Dashboard_v0.9_revision_profesor.pbix)
- Estado: versión candidata para revisión académica.
...
- Presentación inicial: [`presentation/pitch_validacion_inicial/Presentacion_de_avances_NOVAMARKET_Retail.pdf`](presentation/pitch_validacion_inicial/Presentacion_de_avances_NOVAMARKET_Retail.pdf)
...
La entrega está organizada para que el profesor pueda localizar de forma rápida el archivo PBIX, los datos de soporte, la memoria, las capturas y el guion de defensa. La documentación complementaria añadida refuerza la trazabilidad, la validación y el uso del dashboard sin modificar los artefactos analíticos originales.
